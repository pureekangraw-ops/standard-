...
const definitions = [
  ...
  def("go_hub_maintenance", "Run Work-bound Maintenance V4 map inspection, safe probes, repair context, or closeout planning.", "maintenance", schema({ target: { type: "string", enum: ["factory", "go-hub"] }, action: { type: "string", enum: ["inspect", "inspect_map", "mount_map", "eject_map", "run_system_check", "probe_route", "repair_context", "plan_closeout"] }, input: obj, work: obj, map: obj, routeId: str, checkpointId: str, projectId: str, workContext }, ["action", "workContext"]), ann(false)),
