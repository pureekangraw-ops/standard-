...
const definitions = [
  ...
  def("go_hub_counter_inbox", "Read one pending GO↔LIGHT Counter handoff ticket without granting code authority.", "counterInbox", schema({ counterId: str, workContext }, ["counterId", "workContext"]), ann(true)),
