...
const definitions = [
  ...
  def("go_hub_factory_foreman", "Request, release, or inspect Hephaestus lanes.", "factoryForeman", schema({ action: { type: "string", enum: ["request", "release", "state"] }, repository: str, slot: { type: "string", enum: ["assembly", "merge"] }, goId: str, jobId: str, readyGate: obj, piece: obj, assembly: obj, assemblyQc: obj, pullRequest: obj, ci: obj, risk: obj, postMergeVerification: obj, workContext }, ["action", "repository"]), ann(false)),
