...
const definitions = [
  ...
  def("go_hub_maintenance", "Inspect governed Maintenance health/classification capability and route repair to the owning destination.", "maintenance", schema({ target: { type: "string", enum: ["factory"] }, action: { type: "string", enum: ["inspect"] }, input: obj, workContext }, ["target", "action", "input", "workContext"]), ann(true)),
