...
const definitions = [
  ...
  def("go_hub_centre_live_action", "Execute or inspect durable City/Centre live work through GO Hub.", "centreLiveAction", schema({ action: { type: "string", enum: ["start", "inspect", "claim", "renew", "release", "review", "fit", "leave", "return", "record_reality", "cancel", "resume"] }, workId: str, checkpointId: str, returnAddress: str, task: str, requestedResult: str, authority: str, targetId: str, roleId: str, roleReference: str, workingView: str, destination: str, payload: obj, evidence: obj, reuseFit: { type: "boolean" }, ownerId: str, leaseId: str, expectedOwnershipRevision: int, leaseSeconds: int }, ["action", "workId"]), ann(false)),
