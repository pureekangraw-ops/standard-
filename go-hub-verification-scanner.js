const stations=[
  ...
  ["artifact","rebuild-artifact",t=>Boolean(t.buildArtifact?.status==="BUILT"&&t.buildArtifact.sourceHeadSha===t.assembly?.integrationHeadSha&&t.buildArtifact.blueprintRef===t.blueprint?.ref&&t.buildArtifact.digest)],
