...
แอปร้านค้าพื้นฐานสำหรับใช้งานทั่วไป เน้นทำงานประจำวันให้สั้นและตรงบนมือถือ: ขายสินค้า รับสินค้า ดูเงิน ปรับสต็อก และสรุปจบวัน โดยเก็บข้อมูลเข้ารหัสไว้ในเครื่องและรองรับการใช้งานออฟไลน์

- Product version: **1.3.1**
- Worker: `normalpocket`
- หน้าแรกแบบ One-Hand Mobile ลดพื้นที่ซ้ำและเข้าถึงงานหลักได้เร็วขึ้น
- มีคำแนะนำสำหรับร้านใหม่: เพิ่มสินค้าแรกหรือใช้ขายด่วนได้ทันที
