...
function r54ClaimVersionAuthority() {
  ...
  globalThis.YGPH_STANDARD_PRODUCT_VERSION = STANDARD_PRODUCT_VERSION;
  globalThis.__YGPH_R54_VERSION_AUTHORITY__ = STANDARD_PRODUCT_VERSION;
}
...
if (typeof window !== "undefined" && typeof document !== "undefined") {
  (() => {
    ...
    const install = () => {
      if (globalThis.__YGPH_STANDARD_R54_RUNTIME__) return;
      globalThis.__YGPH_STANDARD_R54_RUNTIME__ = true;
      r54ClaimVersionAuthority();
      if (globalThis.YGPHRuntime?.register) {
        globalThis.YGPHRuntime.register("STANDARD_R54_HOME_DASHBOARD", {
