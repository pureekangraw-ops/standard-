...
test("registry publishes six governed Drive bridge tools", async () => {
  ...
  assert.deepEqual(tools.map(tool => tool.annotations.readOnlyHint), [true, true, true, false, false, false]);
