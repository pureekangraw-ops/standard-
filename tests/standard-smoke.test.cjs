...
test("STANDARD offline shell represents the current release and rejects incomplete precache readback", () => {
  assert.equal(sw.RELEASE_ID, "v1.0.0-20260809-r2-defrag-current");
  for (const file of ["index.html", "highway-gate.js", "app.js", "metropolis-r5-4.js", "icon-192.png", "icon-512.png"]) {
