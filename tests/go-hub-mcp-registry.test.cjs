...
test("registry publishes lifecycle plus one Hephaestus Foreman tool with safe annotations", async () => {
  ...
  assert.deepEqual(tools.map(tool => tool.name), [
    ...
    "go_hub_get_failure_evidence", "go_hub_rerun_failed_jobs", "go_hub_factory_action", "go_hub_factory_auto", "go_hub_factory_ready_gate", "go_hub_factory_foreman",
    "go_hub_maintenance", "go_hub_merge_pull_request", "go_hub_get_workflow_runs", "go_hub_list_workflow_artifacts", "go_hub_archive_workflow_artifact", "go_hub_audit_history", "go_hub_centre_inspect", "go_hub_centre_audit_history", "go_hub_centre_live_action", "go_hub_centre_read_only_fast_lane",
    ...
    "go_hub_agent_trigger", "go_hub_counter_create", "go_hub_counter_inbox", "go_hub_counter_get", "go_hub_counter_seen", "go_hub_counter_pickup", "go_hub_counter_answer", "go_hub_counter_readback",
  ...
  assert.equal(tools.find(tool => tool.name === "go_hub_factory_ready_gate").annotations.readOnlyHint, false);
  ...
  assert.equal(tools.find(tool => tool.name === "go_hub_agent_trigger").annotations.readOnlyHint, false);
  ...
  for (const name of [
    ...
    "go_hub_open_pull_request", "go_hub_rerun_failed_jobs", "go_hub_factory_action", "go_hub_factory_auto", "go_hub_factory_ready_gate",
    "go_hub_merge_pull_request", "go_hub_agent_trigger", "go_hub_counter_create", "go_hub_counter_inbox", "go_hub_counter_get", "go_hub_counter_seen", "go_hub_counter_pickup", "go_hub_counter_answer", "go_hub_counter_readback",
    "go_hub_linear_create_issue", "go_hub_linear_update_issue",
    "go_hub_drive_create_folder", "go_hub_drive_move_item", "go_hub_drive_rename_item",
  ]) {
