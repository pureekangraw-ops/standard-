...
test("registry publishes lifecycle plus one Hephaestus Foreman tool with safe annotations", async () => {
  ...
  assert.deepEqual(tools.map(tool => tool.name), [
    ...
    "go_hub_get_failure_evidence", "go_hub_rerun_failed_jobs", "go_hub_factory_action", "go_hub_factory_ready_gate", "go_hub_factory_foreman",
  ...
  for (const name of [
    ...
    "go_hub_open_pull_request", "go_hub_rerun_failed_jobs", "go_hub_factory_action", "go_hub_factory_ready_gate",
