...
test("registry publishes lifecycle plus one Hephaestus Foreman tool with safe annotations", async () => {
  ...
  assert.deepEqual(tools.map(tool => tool.name), [
    ...
    "go_hub_counter_create", "go_hub_counter_inbox", "go_hub_counter_get", "go_hub_counter_seen", "go_hub_counter_answer", "go_hub_counter_readback",
  ...
  for (const name of [
    ...
    "go_hub_merge_pull_request", "go_hub_counter_create", "go_hub_counter_inbox", "go_hub_counter_get", "go_hub_counter_seen", "go_hub_counter_answer", "go_hub_counter_readback",
    "go_hub_linear_create_issue", "go_hub_linear_update_issue",
    "go_hub_drive_create_folder", "go_hub_drive_move_item", "go_hub_drive_rename_item",
  ]) {
